...
python train_celebA.py --dataset celeba --noise gaussian --alpha 0.5 --optimizer adam --batch_size 100 --num_steps 1 --meta_steps 30 --temperature 1.0 --temperature_factor 2 --lr 0.0001 --sigma 0.00001
